...
static const OV7670_command
    ...
    {OV7670_REG_GAM_BASE, 0x05},
    {OV7670_REG_GAM_BASE + 1, 0x10},
    {OV7670_REG_GAM_BASE + 2, 0x20},
    {OV7670_REG_GAM_BASE + 3, 0x30},
    {OV7670_REG_GAM_BASE + 4, 0x40},
    {OV7670_REG_GAM_BASE + 5, 0x55},
    {OV7670_REG_GAM_BASE + 6, 0x66},
    {OV7670_REG_GAM_BASE + 7, 0x76},
    {OV7670_REG_GAM_BASE + 8, 0x88},
    {OV7670_REG_GAM_BASE + 9, 0x92},
    {OV7670_REG_GAM_BASE + 10, 0xA0},
    {OV7670_REG_GAM_BASE + 11, 0xB0},
    {OV7670_REG_GAM_BASE + 12, 0xC3},
    {OV7670_REG_GAM_BASE + 13, 0xD0},
    {OV7670_REG_GAM_BASE + 14, 0xE0},
    {OV7670_REG_COM8, OV7670_COM8_FASTAEC | OV7670_COM8_AECSTEP | OV7670_COM8_BANDING | OV7670_COM8_AEC | OV7670_COM8_AWB},
    {OV7670_REG_GAIN, 0x30},  // Ajuste do ganho para melhorar tons escuros
    {OV7670_REG_COM9, 0x20},  // Limite de ganho inferior para evitar saturação em áreas escuras
    {OV7670_REG_COM11, (1 << 3)}, 
    {OV7670_REG_BD50MAX, 0x08},
    {OV7670_REG_BD60MAX, 0x0A},
    {OV7670_REG_AEW, 0x75},
    {OV7670_REG_AEB, 0x63},
    {OV7670_REG_VPT, 0xA5},
    {OV7670_REG_BRIGHT, 0x50},  // Reduz o brilho para compensar tons escuros
    {OV7670_REG_GGAIN, 0x80},
    {OV7670_REG_CONTRAS, 0x70}, // Aumenta o contraste para melhor definição de tons escuros
    {OV7670_REG_CONTRAS_CENTER, 0x50},
    {OV7670_REG_THL_ST, 0x90},
