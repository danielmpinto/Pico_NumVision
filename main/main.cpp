...
// the chosen interface eg Spi0 CLK=18 DIN=19)
	int8_t SDIN_TFT = 3; // OK
	int8_t SCLK_TFT = 2; // OK
	int8_t DC_TFT = 7; // OK 
	int8_t CS_TFT = 6; // 
	int8_t RST_TFT = 5;
...
int main() {
    ...
    sleep_ms(3000);
    xTaskCreate(lcd_task, "camera_configuration", 256, NULL, 1, NULL);
    xTaskCreate(camera_task, "camera_configuration", 256, NULL, 1, NULL);
    vTaskStartScheduler();
